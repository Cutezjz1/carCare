...
angular.module('ReddyCarCare', [
  'ionic',
  'angularMoment',
  'ReddyCarCare.controllers',
  'ReddyCarCare.directives',
  'ReddyCarCare.filters',
  'ReddyCarCare.services',
  'ReddyCarCare.factories',
  'ReddyCarCare.config',
  'ReddyCarCare.views',
  'underscore',
  'ngMap',
...
.config(function($stateProvider, $urlRouterProvider, $ionicConfigProvider) {
  ...
  .state('app.router', {
    ...
    views: {
      'menuContent': {
        templateUrl: "views/app/router/router.html"
      }
    }
  })
  ...
  .state('app.newcar', {
    ...
    views: {
      'menuContent': {
        templateUrl: "views/app/newCar/newCar.html",
  ...
  .state('app.usedCar', {
    ...
    views: {
      'menuContent': {
        templateUrl: "views/app/usedCar/usedCar.html",
